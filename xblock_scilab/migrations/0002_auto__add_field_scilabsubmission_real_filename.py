...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ScilabSubmission.real_filename'
        db.add_column('xblock_scilab_scilabsubmission', 'real_filename',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ScilabSubmission.real_filename'
        db.delete_column('xblock_scilab_scilabsubmission', 'real_filename')
    ...
    models = {
        ...
        'xblock_scilab.scilabsubmission': {
            ...
            'real_filename': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255'}),
