...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ScilabSubmission'
        db.create_table('xblock_scilab_scilabsubmission', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('sha_1', self.gf('django.db.models.fields.CharField')(max_length=255, db_index=True)),
            ('filename', self.gf('django.db.models.fields.CharField')(max_length=255, db_index=True)),
            ('mimetype', self.gf('django.db.models.fields.CharField')(default='', max_length=255)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=255, db_index=True)),
            ('course', self.gf('django.db.models.fields.CharField')(default='', max_length=255, db_index=True)),
            ('module', self.gf('django.db.models.fields.CharField')(default='', max_length=255, db_index=True)),
            ('size', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('xblock_scilab', ['ScilabSubmission'])


    def backwards(self, orm):
        # Deleting model 'ScilabSubmission'
        db.delete_table('xblock_scilab_scilabsubmission')
    ...
    models = {
        ...
        'xblock_scilab.scilabsubmission': {
            'Meta': {'object_name': 'ScilabSubmission'},
